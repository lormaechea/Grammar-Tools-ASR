...
process_G_FST() {
    ...
    while IFS= read -r line
        do
            ...
            python3 main.py $line > ./mainFST/$fileName.txt
    ...
    for mainGFile in $(ls -v mainFST);
        do
            if [ $fileCounter -le $maxTXTFiles ]; then
                ...
                outputFile=${fileCounter}${extension};
...
unify_G_FST() {
    ...
    # fstdraw --portrait=true --isymbols=newWords.txt --osymbols=newWords.txt ./mainFST/G.fst| dot -Tpng -Gsize=30,60  > ./mainFST/G.png;
    ...
    # fstdraw --portrait=true --isymbols=newWords.txt --osymbols=newWords.txt ./mainFST/G_eps.fst| dot -Tpng -Gsize=30,60  > ./mainFST/G_eps.png;
    ...
    # fstdraw --portrait=true --isymbols=newWords.txt --osymbols=newWords.txt ./mainFST/G_det.fst| dot -Tpng -Gsize=30,60  > ./mainFST/G_det.png;
